...
# Databricks Medallion Pipeline -- Post-Acquisition Data Integration
...
|                                   |      |                                   |
|  [YES] Full Data Pipeline         |      |  [NO] No Data Pipeline            |
|  [YES] Bronze > Silver > Gold     |      |  [NO] Only raw CSV files in S3    |
|  [YES] BI Dashboards active       |      |  [NO] No data quality checks      |
|  [YES] Gold Layer (production)    |      |  [NO] No analytics layer          |
+-----------------------------------+      +-----------------------------------+
                |                                        |
                |         POST-ACQUISITION               |
                v                                        v
...
===============================================
    ...
    +--------------------------------------+
            ...
            v
    +------------------+
    |   UNIFIED BI     |  Combined analytics and reporting
    +------------------+
```
...
|-------|-------------|-----|
| dim_customers | Customer demographics and details | customer_id (PK) |
...
| 5 | Regex Cleaning | Remove unwanted characters and symbols | regexp_replace() |
...
Files are moved from landing/ to processed/ after successful Bronze ingestion to prevent reprocessing.
...
+-------------+---------------+
              v
+-----------------------------+
|  Task 3: Gold Aggregation   |  Star schema joins and business logic
+-------------+---------------+
              v
+-----------------------------+
